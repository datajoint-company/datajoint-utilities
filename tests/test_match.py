...
def test_match(sample_data):
    ...
    verify(
        ...
        level=None,
        expected={
            "ibl_ingest_subject.AlleleSequence": 5,
    ...
    verify(
        ...
        level="table",
        expected={
            "ibl_ingest_subject.AlleleSequence": 1,
    ...
    verify(
        ...
        level="attribute",
        expected={
            "ibl_ingest_subject.AlleleSequence": 2,
    ...
    verify(
        ...
        vms=sample_data[sample_key]["virtual_modules"],
        level="table",
        expected={"rguzman_STRF_pyPL.Movies": 1, "rguzman_STRF_pyPL.MovieFiles": 1},
    )
    verify(
        mask=mask,
        definition=sample_data[sample_key]["definition"],
        vms=sample_data[sample_key]["virtual_modules"],
        level="comment",
        expected={"rguzman_STRF_pyPL.Movies": 2, "rguzman_STRF_pyPL.MovieFiles": 2},
    )
    verify(
        mask=mask,
        definition=sample_data[sample_key]["definition"],
    ...
    verify(
        ...
        vms=sample_data[sample_key]["virtual_modules"],
        level="table",
        expected={"datajoint_monitoring.Host": 1, "datajoint_monitoring.HostMetric": 2},
    )
    verify(
        mask=mask,
        definition=sample_data[sample_key]["definition"],
